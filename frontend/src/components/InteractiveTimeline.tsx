  ...
  const timelineEvents = [
    {
      ...
      type: 'internship',
      description: 'Contributed to multiple private and public web projects under Techies Gateway organization. Worked primarily on frontend technologies and PHP, delivering UI improvements and feature enhancements.',
      achievements: [
        'Contributed actively to repositories including tanvi-cabs, Vijay-Fitness, best-cabs, and smm-frontend.',
        'Completed assigned tasks on schedule, ensuring code quality and UI consistency.',
        'Collaborated with senior developers and team members in hybrid work environment.',
        'Gained hands-on experience with client-facing web projects across various domains such as travel, fitness, finance, and social media management.'
      ],
      technologies: ['HTML5', 'CSS3', 'JavaScript', 'PHP', 'Git', 'GitHub']
    },
    {
      year: '2024',
      ...
      location: 'Hazaribag, Jharkhand, India · Hybrid',
      type: 'internship',
      description: 'Worked on full-stack development using MERN stack to build scalable and maintainable web applications for several projects within Techies Gateway.',
      achievements: [
        'Built and maintained full-stack modules independently in projects like roymedical and admin-smm.',
        'Managed API integrations, enhanced backend logic, and optimized database schemas.',
        'Collaborated in a hybrid setup using GitHub workflows and Postman for API testing.',
        'Contributed to improving project structure and front-end responsiveness across multiple repositories.'
      ],
      technologies: [
        'HTML5', 'CSS3', 'JavaScript', 'React.js', 'Redux.js',
        'Node.js', 'Express.js', 'MongoDB', 'Git', 'GitHub', 'Postman API'
      ]
    }
