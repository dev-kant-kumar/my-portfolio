...
const Footer = () => {
  ...
  const socialLinks = [
    { name: 'GitHub', icon: Github, url: 'https://github.com/devkant' },
    { name: 'LinkedIn', icon: Linkedin, url: 'https://linkedin.com/in/devkant' },
    { name: 'YouTube', icon: Youtube, url: 'https://youtube.com/@devkant' }
  ];
